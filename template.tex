...
\twocolumn[{
  \begin{@twocolumnfalse}
	...
	\begin{center}
		\includegraphics[width=0.85\textwidth]{figures/sampleteaser.pdf}
...
\lipsum[4] See Section \ref{sec:headings}. See Figure \ref{fig:teaser}.
